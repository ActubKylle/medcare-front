    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex justify-center items-center px-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 p-6">
          ...
          <h2 className="text-xl font-bold mt-4 text-center text-white">Create an Account</h2>
          <p className="text-blue-200 text-center mt-1">Join the healthcare management system</p>
        </div>
